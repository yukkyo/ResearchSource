#! /bin/sh
# python 12_RunGibbsSampling.py -k 400 --alpha=0.5 --beta=0.5 -i 1
nohup python 12_RunGibbsSampling.py -k 400 --alpha=0.5 --beta=0.5 -i 250 > out1.log 2> err1.log < /dev/null &
