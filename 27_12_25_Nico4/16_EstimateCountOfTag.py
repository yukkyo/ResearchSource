...
f_estimated_result = "../../ResearchData/Experiment4/after_estimated/"
...
fpath_exp_result = "../../ResearchData/Experiment4/after_Matrix/"
fpath_svm_result = "../../ResearchData/Experiment4/after_SVM/"
...
tag_count_max = max(train_tags_count)
tag_count_min = min(train_tags_count)
print "each tag counts"
for i in range(tag_count_min, tag_count_max):
	print "tagcount " + str(i) + ": " + str(len([l for l in train_tags_count if l == i]))
...
print "calc topic weights of test corpus"
topic_weight_test = []
...
# テスト文書のタグ数を推定する
print "SVM: learning phase"
clf = svm.LinearSVC(C=1.0)
clf.fit(topic_weight_train, train_tags_count)
print "SVM: learning end"
print "SVM: predict phase"
